...
export async function generateMetadata({ params }: { params: Promise<{ username: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Check out ${username}'s developer stats and rarity tier on AvatarARC.`,
    openGraph: {
      images: [{ url: `/api/card/${username}/og`, width: 1200, height: 630 }],
    },
    twitter: {
      card: 'summary_large_image',
      images: [`/api/card/${username}/og`],
    },
  };
}
